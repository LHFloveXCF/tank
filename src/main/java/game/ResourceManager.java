...
public class ResourceManager {
    ...
    static {
        try {
            // tankU = ImageIO.read(game.ResourceManager.class.getResourceAsStream("/images/tankU.gif"));
            // tankD = ImageIO.read(game.ResourceManager.class.getResourceAsStream("/images/tankD.gif"));
            // tankL = ImageIO.read(game.ResourceManager.class.getResourceAsStream("/images/tankL.gif"));
            // tankR = ImageIO.read(game.ResourceManager.class.getResourceAsStream("/images/tankR.gif"));
